...
console.log("Örnek Görev- Karenin Alanı: ", KareninAlani(10));
...
console.log("Görev 1: Çemberin Çevresi: ", CemberinCevresi(3));

/* (Oto test yok) Yukarıdaki CemberinCevresi fonksiyonunu yarıçap = 5 vererek aşağıda çalıştırıp, sonucu konsolda gözlemleyin (console.log)  */
console.log("Görev 1: Çemberin Çevresi: ", CemberinCevresi(5));
...
console.log("Görev 2: Çemberin Alanı: ", CemberinAlani(5, pi));

/* (Oto test yok) Yukarıdaki CemberinAlani fonksiyonunu yarıçap = 15 vererek aşağıda çalıştırıp, sonucu konsolda gözlemleyin (console.log)  */
console.log("Görev 2: Çemberin Alanı: ", CemberinAlani(15, pi));
...
console.log("Görev 3b. Üçe Tam Bölünenler Dizisi: ", ucetambolunenler);

//3c çözümü:

/* 3c. `ucetambolunenler` dizisindeki sayıların toplamını .reduce metoduyla bulup, sonucu `ucebolunenlerintoplami` değişkenine yazdırın (.reduce metodunu kullanın) */

ucebolunenlerintoplami = ucetambolunenler.reduce((toplam, ucunKatlari) => {
  return toplam + ucunKatlari;
}, 0);
...
console.log("Görev 3d. Beş Yüzden Küçük Sayılar: ", besyuzdenkucuksayilar);
//3e çözümü
...
console.log("Görev 3e. Beş Yüzden Küçük ve Sıralı: ", siralisayilar);
